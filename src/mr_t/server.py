...
class Arguments(Tap):
    ...
    status_port: int | None = None # Port where you can connect via tcp to get the current status
...
async def main_async() -> None:
    ...
    async def handle_status(_reader: asyncio.StreamReader, writer: asyncio.StreamWriter) -> None:
